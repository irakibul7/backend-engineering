...
export const NETWORK_SCENARIOS: readonly NetworkScenario[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      step("Reply", "The gateway replies in this trusted example", "The gateway answers with its MAC address and directs the reply back to the client.", "The reply supplies a claimed neighbor mapping. ARP does not authenticate its sender.", ["client", "router-a"], ["client-router"], [{ label: "192.0.2.1", value: "02:00:00:00:01:01" }, { label: "Delivery", value: "Unicast reply" }]),
